...
class ListenersTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->product1   = new Product(SKU::set('123'), Name::set('Product 1'), $price, new StubTaxRate);
        $this->product2   = new Product(SKU::set('456'), Name::set('Product 2'), $price, new StubTaxRate);
