...
class ValueCalculatorTest extends \PHPUnit_Framework_TestCase
{
    /** @var Calculator */
    private $calculator;
    ...
    public function setUp()
    {
        ...
        $this->calculator = new ValueCalculator($reconciler);
    }

    /** @test */
    public function should_return_the_name_of_the_calculator()
    {
        $this->assertEquals('value', $this->calculator->name());
    }
