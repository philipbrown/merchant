...
use PhilipBrown\Merchant\Calculators\TaxableCalculator;

class TaxableCalculatorTest extends \PHPUnit_Framework_TestCase
{
    /** @var Calculator */
    private $calculator;
    ...
    public function setUp()
    {
        ...
        $this->calculator = new TaxableCalculator;
    }

    /** @test */
    public function should_return_the_name_of_the_calculator()
    {
        $this->assertEquals('taxable', $this->calculator->name());
    }
